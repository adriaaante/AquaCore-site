...
function Roles() {
  const roles = [
    ...
    { icon: "car" as const, t: "Мойщик", d: "Простая очередь задач с крупными кнопками и заработком в реальном времени." },
...
function Security() {
  const items = [
    ...
    { icon: "bolt" as const, t: "Детектор злоупотреблений", d: "15+ признаков: крупные скидки, расхождения по кассе, возвраты, оплаты без мойщика." },
