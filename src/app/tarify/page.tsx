...
const compare: { feature: string; basic: boolean; pro: boolean }[] = [
  ...
  { feature: "Модуль «SMS-уведомления» (SMS-чек, «машина готова»)", basic: false, pro: true },
...
const pricingFaq = [
  ...
  },
  {
    ...
    a: "Система модульная. Базовый тариф — это полноценное ядро управления мойкой. Сверху по подписке подключаются модули «Клиентский кабинет» и «SMS-уведомления». Тариф «С кабинетом» — это базовый плюс оба модуля. Модули можно включить в любой момент одной галочкой в настройках, данные при этом не теряются.",
  },
  {
          ...
          <div className="container-x text-center">
            <Reveal>
              ...
              <p className="lead mx-auto mt-5 max-w-2xl">
                ...
                функционал. Дешевле аналогов — и без скрытых доплат за отдельные функции.
              </p>
            </Reveal>
          </div>
        </section>
