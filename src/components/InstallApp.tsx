  ...
  const steps = [
    {
      icon: "link" as const,
      t: "Открываете ссылку",
      d: "Клиент переходит по ссылке вашей мойки или сканирует QR-код на кассе — прямо в браузере телефона.",
    },
    {
      icon: "check" as const,
      t: "Добавляете на экран",
      d: "Одно касание — и значок AquaCore появляется на главном экране рядом с остальными приложениями.",
    },
    {
      icon: "phone" as const,
      t: "Заходите как в приложение",
      d: "Дальше открывается с экрана в один тап, на весь экран, без адресной строки — как обычное приложение.",
    },
  ];
      ...
      <div className="container-x grid min-w-0 items-center gap-12 lg:grid-cols-2 [&>*]:min-w-0">
        <Reveal>
          <span className="eyebrow">
            <Icons.phone className="h-3.5 w-3.5" /> Как у клиента на телефоне
          </span>
          <h2 className="mt-5 h-title">Заходит как обычное приложение — ничего сложного</h2>
          <p className="lead mt-4">
            AquaCore не нужно искать и скачивать в App Store или Google Play. Клиент просто
            открывает ссылку вашей мойки — и добавляет её на главный экран. Дальше значок
            стоит рядом с остальными приложениями, а открывается в один тап и на весь экран.
          </p>
          ...
          <p className="mt-8 rounded-xl border border-brand-100 bg-brand-50/60 p-4 text-sm text-ink-soft">
            <span className="font-semibold text-brand-700">Работает на любом телефоне.</span>{" "}
            И на iPhone, и на Android — без установки из магазина приложений, без паролей,
            вход через Telegram в одно касание.
          </p>
        </Reveal>
