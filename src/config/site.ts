...
export const site = {
  ...
  description:
    "AquaCore — программа для автомойки и шиномонтажа: доска заказов в реальном времени, распознавание госномеров, программа лояльности, контроль кассы, зарплата сотрудникам, аналитика и отчёты под рукой. Светлая и тёмная тема. Первые 14 дней бесплатно. Базовый тариф — 50 000 ₽ в год.",
