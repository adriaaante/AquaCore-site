...
export const site = {
  ...
  description:
    "AquaCore — программа для автомойки и шиномонтажа: доска заказов в реальном времени, распознавание госномеров, программа лояльности, контроль кассы, зарплата сотрудникам, аналитика и отчёты под рукой. Всё просто, бизнес зарабатывает больше. Базовый тариф — 50 000 ₽ в год.",
